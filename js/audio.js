...
BATO.AudioManager = {
  ...
  musicPlaying: false, currentMusic: null,
  ...
  playMelody(notes, type='square', vol=0.12, tempo=200){
    let beat = 60/tempo;
    notes.forEach((n,i)=>{
      if(n>0) this.playNote(n, beat*0.8, type, vol, i*beat);
    });
  },
  ...
  stopMusic(){
    ...
    if(this.currentMusic){ clearInterval(this.currentMusic); this.currentMusic=null; }
  },
